...
ALTER COLUMN MAKH INT IDENTITY(1,1)

ALTER TABLE KHAHCHANG DROP COLUMN MAKH
ALTER TABLE KHACHHANG ADD MAKH INT IDENTITY(1,1) PRIMARY KEY
...
ALTER TABLE HOADON ADD MAKH INT IDENTITY(1,1)
...
ALTER TABLE dbo.CTHD ADD CONSTRAINT FK_CTHD_HOADON FOREIGN KEY (MHD) REFERENCES dbo.HOADON (MAHD)
...
ALTER TABLE dbo.HOADON ADD CONSTRAINT FK_HOADON_THANHTOAN FOREIGN KEY (IDTHANHTOAN) REFERENCES dbo.THANHTOAN (IDTHANHTOAN)

ALTER TABLE dbo.HOADON ADD CONSTRAINT FK_HOADON_KHACHHANG
ALTER TABLE dbo.HOADON ADD CONSTRAINT FK_HOADON_NHANVIEN
ALTER TABLE dbo.CTHD ADD CONSTRAINT FK_CTHD_HOADON
ALTER TABLE dbo.HOADON ADD CONSTRAINT FK_HOADON_THANHTOAN

ALTER TABLE dbo.KHACHHANG DROP CONSTRAINT PK__KHACHHAN__603F592C5B41416A
...
INSERT INTO NHANVIEN VALUES ('NV1', N'Nguyễn Thành Luân', '2001-6-6','0386843039',N'Quản trị viên', 'admin', '1111','#','#')
...
-- thanh toan (sl 3)
INSERT INTO THANHTOAN VALUES(1,N'Tiền mặt')
INSERT INTO THANHTOAN VALUES(2,N'Chuyển Khoảng')
